package cn.ntit.passwordmanager.service;
...
import cn.ntit.passwordmanager.MainActivity;
import cn.ntit.passwordmanager.R;
import cn.ntit.passwordmanager.VaultApp;
...
public class EchoValueAutofillService extends AutofillService {
    ...
    private boolean isPasswordType(android.app.assist.AssistStructure.ViewNode node) {
        ...
        return type == 1 && (node.getInputType() & 0x80) != 0;
    }
